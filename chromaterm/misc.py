...
- description: IPv4
  regex: ((?<=\W)|^)(?<!\.)((25[0-5]|(2[0-4]|[0-1]?\d)?\d)\.){3}(25[0-5]|(2[0-4]|[0-1]?\d)?\d)(/\d+)?(?!\.)((?=\W)|$)
  color: f#00ffff
...
- description: MAC (11:22:33:44:55:66)
  regex: (?i)((?<=\W)|^)(?<!:)([0-9a-f]{1,2}:){5}[0-9a-f]{1,2}(?!:)((?=\W)|$)
  color: f#5f61ad

- description: MAC (1122.3344.5566)
  regex: (?i)((?<=\W)|^)(?<!\.)([0-9a-f]{4}\.){2}[0-9a-f]{4}(?!\.)((?=\W)|$)
  color: f#5f61ad
