...
- ChromaTerm-- **multithreads** the input and output operations which significantly increases the **responsiveness**, and allowed polling to be removed. Furthermore, this nearly negates the overhead of CT while wrapping around a process.
